...
class BeautifulSoup(Tag):
    ...
    def __init__(self, markup="", features=None, builder=None,
                 ...
                 exclude_encodings=None, element_classes=None,
                 replacer=None, **kwargs):
        self.replacer = replacer
    
        if builder is not None:
            setattr(builder, "replacer", replacer)
        """Constructor.
    ...
    def handle_starttag(
        ...
        :meta private:
        """
        # If a SoupReplacer was passed, modify tag name before creation
        if hasattr(self, "replacer") and self.replacer:
            name = self.replacer.replace_tag(name)
